...
/// <summary>
/// Retourn le chemin relatif du fichier correspondant à la position dans le menu d'Accueil
/// </summary>
/// <param name="positionAccueil"></param>
/// <returns></returns>
//std::string numCaseAccueil(const int& positionAccueil)
//{
//	switch (positionAccueil)
//	{
//	case 0:
//		return "play.png";
//	case 1:
...
/// <summary>
/// Indique le dossier où aller chercher les ressources selon la position dans le jeu
/// </summary>
